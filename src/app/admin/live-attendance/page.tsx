...
export default function LiveAttendancePage() {
  ...
  const handleIdentifyAndMark = async () => {
    ...
    try {
        ...
        const matchedStudent = enrolledStudents.find(s => s.photoHash === currentHash);
        ...
        if (alreadyMarked) {
            ...
            setMessage(`Attendance has already been marked for ${matchedStudent.name} today.`);
            return;
        }
        ...
        setStatus('success');
        setMessage(`${matchedStudent.name} (${matchedStudent.registerNumber}) has been marked as present.`);
        toast({
