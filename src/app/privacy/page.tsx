      ...
      <div className="relative w-full max-w-4xl z-10 py-12">
        <Card className="bg-card/60 backdrop-blur-sm border-border/50 shadow-lg">
          ...
          <CardContent className="space-y-4 prose prose-invert max-w-none">
            <p>JSS Polytechnic ("us", "we", or "our") operates this website (the "Service").</p>
            ...
            <p>We collect several different types of information for various purposes to provide and improve our Service to you. This includes, but is not limited to, student names, registration numbers, and contact information for the Smart Attendance system.</p>
            <h3 className="text-xl font-semibold text-card-foreground"><strong>Use of Data</strong></h3>
            <p>JSS Polytechnic uses the collected data for various purposes:</p>
            <ul>
